...
#ifndef LINUX_SOCKET_IO_IMPL_INCLUDED
#define LINUX_SOCKET_IO_IMPL_INCLUDED
#include "../io/linux_socket_io_impl.h"
#endif
...
int main(const int argc, const char *argv[])
{
    ...
    *cout << "Starting...";
    ...
    IOAsRunner *io_runner{new LinuxSocketIoImpl{cout, args, runner}};
