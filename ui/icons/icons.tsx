"use client"
import { AnonymousRaw, AttachRaw, AuthorRaw, BackRaw, ChartRaw, CheckRaw, DangerRaw, DeleteRaw, DownRaw, EnterRaw, ErrorRaw, ExitRaw, FeedRaw, FileRaw, FilterRaw, ForwardRaw, GlobeRaw, InfoRaw, LeftRaw, LockedRaw, MaximizeRaw, MinimizeRaw, NoUserRaw, PinRaw, QuestionRaw, RedoRaw, RespondentRaw, RightRaw, UndoRaw, UpRaw, UploadRaw, WindowRaw, NewRaw, SwitchRaw } from "./raw_icons.tsx";
//@@@START@@@
// Don't remove the above line it's for script
...
// Don't remove the below line it's used for script
//@@@END@@@
export function Anonymous(props: FaviconProps) {
        return <WrapIcon icon={AnonymousRaw} {...props} />
    }
...
export function Author(props: FaviconProps) {
        return <WrapIcon icon={AuthorRaw} {...props} />
    }
...
export function NoUser(props: FaviconProps) {
        return <WrapIcon icon={NoUserRaw} {...props} />
    }
...
export function Respondent(props: FaviconProps) {
        return <WrapIcon icon={RespondentRaw} {...props} />
    }
