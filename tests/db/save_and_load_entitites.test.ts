...
describe.serial("test that survey is saved to database", async () => {
    // Initialize database
    ...
    test("get turns", async () => {
        ...
        const shouldBeError = getAllEntities<Turn>(result as QueryResult[]);
        expect(shouldBeError).not.toBeInstanceOf(Error);

        const entitiesOrError = getAllEntities<Turn>(result as QueryResult[]);
    ...
    test("get surveys", async () => {
        ...
        const entitiesOrError = getAllEntities<Survey>(result as QueryResult[]);
        expect(entitiesOrError).not.toBeInstanceOf(Error);
...
describe.serial(
    "test that user, session, password is saved to database",
    async () => {
        // Initialize database
        await testInitializer.removeAllRows();
        ...
        test("get one user", async () => {
            ...
            const result = await executeStatements(statements, testPool);
            expect(result).not.toBeInstanceOf(Error);
            const entities = getAllEntities<Respondent>(
                result as QueryResult[]
            );
            expect(entities).not.toBeInstanceOf(Error);
            expect(entities).not.toBeNull();
        ...
        test("get two users", async () => {
            ...
            const result = await executeStatements(statements, testPool);
            expect(result).not.toBeInstanceOf(Error);
            const entities = getAllEntities<User>(result as QueryResult[]);
            expect(entities).not.toBeInstanceOf(Error);
            expect(entities).not.toBeNull();
